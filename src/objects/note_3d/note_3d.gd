...
const red_mat = preload("res://src/objects/note/red_note_mat.tres")
const yellow_mat = preload("res://src/objects/note/yellow_note_mat.tres")
const blue_mat = preload("res://src/objects/note/blue_note_mat.tres")
const orange_mat = preload("res://src/objects/note/orange_note_mat.tres")
const green_mat = preload("res://src/objects/note/green_note_mat.tres")
const purple_mat = preload("res://src/objects/note/purple_note_mat.tres")
...
func set_color(string):
	$CSGBox.material = mats[string]
	$CSGTail.material = mats[string]
